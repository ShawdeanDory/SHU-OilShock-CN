            ...
            rows.append(
                {
                    ...
                    "specification": "future outcome on reduced-form OilShock innovation with lagged outcome/shock, USD, GPR, month, COVID; block bootstrap intervals",
                    "shock_identification": "reduced_form_ARX_oil_price_innovation_not_structural_supply_shock",
                    "sample_start": usable["period"].iloc[0],
                    "sample_end": usable["period"].iloc[-1],
                    "n": int(len(usable)),
                }
...
def annotate_lp_inference(irf: pd.DataFrame) -> pd.DataFrame:
    ...
    result["supports_growth_loss_language"] = False
    return result
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        "outcomes": outcomes,
        "shock_identification": "OilShock is a reduced-form ARX oil-price innovation, not a Kilian structural supply shock.",
