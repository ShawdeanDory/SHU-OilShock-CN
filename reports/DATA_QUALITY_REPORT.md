...
| `oecd_kei_ip_monthly` | `PASS` | 591 | 2010-01-01 | 2026-05-01 | 0 | 0 | DEU/JPN/KOR 各197期；中国活动变量使用另行导入的国家统计局序列 |
...
| 条目 | 状态 | 回退 |
| --- | --- | --- |
| 国家统计局工业增加值、PPI 完整月表 | `PASS` | 已进入 Q2 月度 LP；工业增加值官方结构性空值按缺失处理 |
